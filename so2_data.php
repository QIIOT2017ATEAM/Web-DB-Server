...
function createCircles2(){
  ...
  for (var data in markerJson)
  {
    ...
    else if(markerJson[data].so2 <= 100)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].so2 <= 150)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].so2 <= 200)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].so2 <= 300)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].so2 <= 500)
    {
      cityCircle = new google.maps.Circle
      (
        {
