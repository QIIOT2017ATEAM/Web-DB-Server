    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i> AQI Air Data(PM2.5)</h3>
...
function createCircles2(){
  ...
  for (var data in markerJson)
  {
    ...
    else if(markerJson[data].pm25 <= 100)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].pm25 <= 150)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].pm25 <= 200)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].pm25 <= 300)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].pm25 <= 500)
    {
      cityCircle = new google.maps.Circle
      (
        {
...
function drawChart()
{
  ...
  $.ajax({
    ...
    async: false,
    global: false,
    url: "/slim-api/pm25_dynamic_chart_json",
    dataType:"json",
    complete: function()
    {
