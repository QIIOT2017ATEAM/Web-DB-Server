...
function createCircles2(){
  ...
  for (var data in markerJson)
  {
    ...
    else if(markerJson[data].o3 <= 100)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].o3 <= 150)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].o3 <= 200)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].o3 <= 300)
    {
      cityCircle = new google.maps.Circle
      (
        {
    ...
    else if(markerJson[data].o3 <= 500)
    {
      cityCircle = new google.maps.Circle
      (
        {
