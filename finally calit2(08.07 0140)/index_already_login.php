    ...
    <aside>
      <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"><?php echo $_SESSION['first_name'] ?></h5>
...
var aqiboxes_ignore = false;
              ...
              <div class="col-md-4 col-sm-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <font size="7" color="#26352b"><p id="temperature"></p></FONT>
                      ...
                      <br></br>
                      <div id="map" style="width:90%;height:300px;margin-left:50px">
  ...
  function initMap()
  {
    ...
    {
      zoom: 10,
      center: {lat: 32.8825295, lng: -117.0000000},
      ...
      var cityCircle = new google.maps.Circle(
        {
          ...
          radius: Math.sqrt(air[data].co) * 1000
        });
      }
      else if(20 >= air[data].co)
      {
        var cityCircle = new google.maps.Circle(
          {
            strokeColor: '#0000FF',
