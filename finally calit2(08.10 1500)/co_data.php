...
for (var data in markerJson)
      {
        ...
        else if(markerJson[data].co <= 100)
        {
          var cityCircle = new google.maps.Circle
          (
            {
        ...
        else if(markerJson[data].co <= 150)
        {
          var cityCircle = new google.maps.Circle
          (
            {
        ...
        else if(markerJson[data].co <= 200)
        {
          var cityCircle = new google.maps.Circle
          (
            {
        ...
        else if(markerJson[data].co <= 300)
        {
          var cityCircle = new google.maps.Circle
          (
            {
        ...
        else if(markerJson[data].co <= 500)
        {
          var cityCircle = new google.maps.Circle
          (
            {
          ...
          (
            {
              ...
              radius: 25
                    ...
                    window.setTimeout(createCircles2, 2000);
                  }createCircles2();
