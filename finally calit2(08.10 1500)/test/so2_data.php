...
{
  //로그인이 되어 있을경우
  echo "<meta http-equiv='refresh' content='0;url=so2_data_already_login.php'>";
}
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <h3><i class="fa fa-angle-right"></i> AQI Air Data(SO2)</h3>
              <!-- page start-->
    ...
    setTimeout(initMap,5000);
      ...
      <script async defer
          src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD86b9sJjkFW_qqvPMXgFcs_K1Zt6Xj3fc&callback=initMap">
      </script>
...
// Draw the chart and set the chart values
    ...
    function drawChart()
    {
      ...
      var jsonData = $.ajax({
                url: "/slim-api/so2_dynamic_chart_json",
                dataType:"json",
                complete: function()
                {
