<?php
    session_start();
    if(!isset($_SESSION['user_id']) || !isset($_SESSION['user_password']) || !isset($_SESSION['user_name'])) 
    {
        //로그인이 되어있지 않다면 아래를 실행한다. (로그인 된 index를 띄워야 할 것이다.)
        //echo "not login";
...
-->
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="realtime_data.php">RealTime</a></li>
    ...
    <script>
        function myMap() {
            var mapProp= {
                center:new google.maps.LatLng(32.880853,-117.235988),
                zoom:6,
            };
