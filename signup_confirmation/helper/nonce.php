...
//Android send_code(forgot password)
...
//Web Client send_code(forgot password)
function send_code3($nonce,$user_id){
  //require 'signup_confirmation/PHPMailer/PHPMailerAutoload.php';
  $mail = new PHPMailer;
  ...
  {
    //echo 'Message has been sent';
    echo "<script>location.replace('../reset_password_email.html');</script>";
  }
}
